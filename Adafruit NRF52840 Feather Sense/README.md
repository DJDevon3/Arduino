...
This is all offline real-time sensor data. Shows all 9 of the Feather Sense's onboard sensors on the TFT display. The RGB value is for the onboard neopixel.
